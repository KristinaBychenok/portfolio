...
export const customTheme: CustomFlowbiteTheme['carousel'] = {
  root: {
    ...
    leftControl:
      'absolute top-[-90px] right-[40px] xl:top-[-100px] h-[44px] p-2.5 rounded-md hover:bg-yellow-100 hover:bg-opacity-50 hover:shadow-main active:bg-yellow-200 active:bg-opacity-50',
    rightControl:
      'absolute top-[-90px] right-[-30px] xl:top-[-100px] h-[44px] p-2.5 rounded-md hover:bg-yellow-100 hover:bg-opacity-50 hover:shadow-main active:bg-yellow-200 active:bg-opacity-50',
  },
}
